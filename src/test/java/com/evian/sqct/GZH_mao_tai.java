...
public class GZH_mao_tai {
    ...
    public MaoTaiShopsBean monitoringMaoTaiShops(String lamboKey, String token){
    ...
    public MaoTaiProductsBean helpBoxShopId(String lamboKey, String token, String shopId){
        Map<String,String> param = new HashMap<>();
