 ...
 * @mender wanglf
 * @Description: Java加密解密工具  SHA1 MD5 BASE64编码 AES加密
 * @date 2018年6月30日 下午3:38:21
 */
public class EnDecryptUtil {
    private static Logger log = LoggerFactory.getLogger(EnDecryptUtil.class);

    // 密钥
    private final static String secretKey = "wanglf@sina.com";
    // 向量
...
// log.info("3DES 解密 ： " + d3esDecode(d3esEncode("arr1")));
 /*log.info("AES 加密 ： " + encryptBitAES("1499".getBytes(), "arr1"));
        log.info("AES 解密 ： " + decryptBitAES("7kfk5ZjD8oA9r5tks0DjeA==".getBytes(),
                "sY1IpDQYwSqwIyY3TS7qpQ=="));*/
