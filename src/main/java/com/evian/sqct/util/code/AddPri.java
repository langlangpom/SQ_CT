package com.evian.sqct.util.code;
...
public class AddPri {
    ...
    public static String generateQRCode(String text, int width, int height, String format) throws Exception {
        ...
        String pathName = "C:\\Users\\XHX\\Desktop\\new.png";
     ...
     * @throws Exception
     */
    public static BufferedImage generateQRCodeOutput(String text, int width, int height, String format) throws Exception {
        Hashtable<EncodeHintType, Object> hints = new Hashtable<EncodeHintType, Object>();
        hints.put(EncodeHintType.CHARACTER_SET, "utf-8");
        // 边框空白大小
        hints.put(EncodeHintType.MARGIN, 0);
