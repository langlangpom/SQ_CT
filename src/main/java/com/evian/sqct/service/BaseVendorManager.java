...
//			List<Map<String, Object>> mappingSelect = vendorDao.vendorReplenishmentPlanMappingSelectNoShopId(mainboardId);
	...
	public Map<String, Object> refundApply(Integer orderId, Double applyRefundMoney,String applyRemark, String cellphone, String openId) {
		logger.info("[orderId:{}] [applyRefundMoney:{}] [applyRemark:{}] [cellphone:{}] [openId:{}]",
				new Object[] {orderId, applyRefundMoney,applyRemark, cellphone, openId});
		return vendorDao.refundApply(orderId, applyRefundMoney,applyRemark, cellphone, openId);
	}

	public Map<String, Object> Proc_Backstage_vendor_order_select_groupByMainboardIdOrProductId(Integer statisticsType,String beginTime,String endTime,String eName,Integer eid,String mainboardNo,Integer orderStatus,Integer dataSourse,Boolean isPay,String productName,String shopName,Integer doorIndex,Boolean isTest,Integer buyTimesMoreThen,String cellphone,Integer PageIndex,Integer PageSize,Boolean IsSelectAll){
		logger.info("[statisticsType:{}] [beginTime:{}] [endTime:{}] [eName:{}] [eid:{}] [mainboardNo:{}] [orderStatus:{}] [dataSourse:{}] [isPay:{}] [productName:{}] [shopName:{}] [doorIndex:{}] [isTest:{}] [buyTimesMoreThen:{}] [cellphone:{}] [PageIndex:{}] [PageSize:{}] [IsSelectAll:{}]",
				new Object[] {statisticsType, beginTime, endTime, eName, eid, mainboardNo, orderStatus, dataSourse, isPay, productName, shopName, doorIndex, isTest, buyTimesMoreThen, cellphone, PageIndex, PageSize, IsSelectAll});
		return vendorDao.Proc_Backstage_vendor_order_select_groupByMainboardIdOrProductId(statisticsType, beginTime, endTime, eName, eid, mainboardNo, orderStatus, dataSourse, isPay, productName, shopName, doorIndex, isTest, buyTimesMoreThen, cellphone, PageIndex, PageSize, IsSelectAll);
	}

	public Map<String, Object> Proc_Backstage_vendor_replenishment_select(String beginTime,String endTime,Integer eid,String account,String productCode,String productName,Boolean isTest,String containerCode,Integer doorIndex,Integer PageIndex,Integer PageSize,Boolean IsSelectAll){
		logger.info("[ent:{}] [beginTime:{}] [endTime:{}] [eid:{}] [account:{}] [productCode:{}] [productName:{}] [isTest:{}] [containerCode:{}] [doorIndex:{}] [PageIndex:{}] [PageSize:{}] [IsSelectAll:{}] ",
				new Object[] {"vendorAppMerchantProductStorageDetailSelect",beginTime,endTime,eid,account,productCode,productName,isTest,containerCode,doorIndex,PageIndex,PageSize,IsSelectAll});
		return vendorDao.Proc_Backstage_vendor_replenishment_select(beginTime, endTime, eid, account, productCode, productName, isTest,containerCode, doorIndex,PageIndex, PageSize, IsSelectAll);
	}
}
