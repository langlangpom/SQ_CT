...
public class BaseRuntimeException extends RuntimeException {
    ...
    public static BaseRuntimeException.ResultErrorCodeMessage jointCodeAndMessage(int code){
        return new BaseRuntimeException.ResultErrorCodeMessage(BaseRuntimeException.ResultErrorCodeMessage.jointCodeMessage(code, Constants.getCodeValue(code)));
    }
