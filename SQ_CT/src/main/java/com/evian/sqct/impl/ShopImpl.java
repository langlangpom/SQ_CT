...
//						 cs.registerOutParameter("TAG", Types.NVARCHAR);//
	...
	public List<FindShopModel> selectShopByEidAndShopId(final Integer shopId,
			final Integer eid) {
		List<FindShopModel> result = jdbcTemplate
				.execute(
	...
	public City selectCityByCityIdAndDistrictId(Integer cityId,
		...
		City city = new City();
		city = jdbcTemplate.queryForObject(sql, new Object[] { cityId,
	...
	public List<ShopCode> selectShopCode(final Integer eid, final Integer shopId) {
		List<ShopCode> result = jdbcTemplate
				.execute(
	...
	public Integer insertShopProduct(Integer shopId, Integer pid, Double shopPrice) {
		String sql="insert into e_shop_product(shopId,pid,shopPrice) values(?,?,?)";
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Override
	public Map<String, Object> appMerchantTodayStatistics(final Integer accountId,final  Integer shopId) {
	...
	public Map<String, Object> shopLeagueClientsSelect(final String beginTime, final String endTime,final  Integer shopId, final Integer eid,
			final String nickName, final String cellphone, final Integer PageIndex, final Integer PageSize, final Boolean IsSelectAll) {
		Map<String,Object> result = jdbcTemplate.execute(
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Override
	public List<Map<String, Object>> selectMyVouchers(final Integer clientId) {
		List<Map<String,Object>> result = jdbcTemplate.execute(
	...
	public Integer updateShop(Integer shopId, String pictureUrl, String tel, String shopName,String startTime,String	endTime) {
		...
		if(StringUtils.isEmpty(pictureUrl)&&StringUtils.isEmpty(tel)&&StringUtils.isEmpty(shopName)&&StringUtils.isEmpty(startTime)&&StringUtils.isEmpty(endTime)) {
			return 0;
		}
