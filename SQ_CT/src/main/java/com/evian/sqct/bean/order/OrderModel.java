...
public class OrderModel {
	...
	public String toString() {
		return "OrderModel [row=" + row + ", orderId=" + orderId
				+ ", orderGroup=" + orderGroup + ", orderNo=" + orderNo
				+ ", eid=" + eid + ", shopId=" + shopId + ", clientId="
				+ clientId + ", did=" + did + ", sendAddress=" + sendAddress
				+ ", phone=" + phone + ", contacts=" + contacts
				+ ", dateCreated=" + dateCreated + ", appointmentTime="
				+ appointmentTime + ", sendRemark=" + sendRemark + ", account="
				+ account + ", sdkType=" + sdkType + ", mobileType="
				+ mobileType + ", mobileIMEl=" + mobileIMEl + ", appVer="
				+ appVer + ", orderRemark=" + orderRemark + ", ticketCount="
				+ ticketCount + ", cashTotal=" + cashTotal + ", linePayTotal="
				+ linePayTotal + ", linePaySuceed=" + linePaySuceed
				+ ", payMode=" + payMode + ", status=" + status
				+ ", ifEvaluate=" + ifEvaluate + ", ifMutual=" + ifMutual
				+ ", mutualTime=" + mutualTime + ", mutualId=" + mutualId
				+ ", deliverTime=" + deliverTime + ", deliverMan=" + deliverMan
				+ ", completeTime=" + completeTime + ", privilegeId="
				+ privilegeId + ", discountMoney=" + discountMoney
				+ ", discountDescribe=" + discountDescribe + ", has_invoice="
				+ has_invoice + ", shopName=" + shopName + ", eName=" + eName
				+ ", receivableTotal=" + receivableTotal + ", cancelTime="
				+ cancelTime + ", cancelReason=" + cancelReason + ", in_come="
				+ in_come + ", comeDate=" + comeDate + ", has_retrn="
				+ has_retrn + ", paymentMoney=" + paymentMoney
